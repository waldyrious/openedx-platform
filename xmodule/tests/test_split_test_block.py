...
class SplitTestBlockLMSTest(SplitTestBlockTest):
    ...
    def test_child(self, user_tag, child_url_name):
        ...
        assert self.split_test_block.child_block.usage_key.block_id == child_url_name
    ...
    def test_child_missing_tag_value(self, _user_tag):
        ...
        assert self.split_test_block.child_block.usage_key.block_id in ['split_test_cond0', 'split_test_cond1']
    ...
    def test_child_persist_new_tag_value_when_tag_missing(self, _user_tag):
        ...
        assert (
            self.split_test_block.child_block.usage_key.block_id
            == self.split_test_block.child_block.usage_key.block_id
        )
